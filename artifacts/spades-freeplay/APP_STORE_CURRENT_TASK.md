...
| EAS build ID | b27f92d9-353f-4644-91b9-0d0fe55742eb |
| EAS submission ID | 49459310-b405-4553-9176-47edeb69611e |
...
- [ ] Apple processing complete for build 31
- [ ] Build 31 added to internal TestFlight testing
...
1. Wait for Apple processing to finish for build 31.
2. Add build 31 to internal TestFlight testing.
...
- [ ] Smoke test visual layout failure seen on build 21: iPhone bidding/game screen clipped horizontally, score counters overflowed past the right edge, bid modal was too wide/tall for the viewport, bottom hand was partially cut off, and the Report Bug button truncated. Build 31 uses the live fixed `1v1spades.com` deployment; do not mark smoke test complete until build 31 is built, submitted, processed, installed, and verified on device.
...
- Build 31 remains the release candidate unless smoke testing finds a blocker.
