 ...
 *
 * These point to the existing public website. The in-app experience is casual
 * play only; competitive tournaments are hosted on the website, opened in the
 * device browser — never inside this app.
 */
export const LINKS = {
